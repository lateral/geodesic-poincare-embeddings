...
class Vector {
    ...
    public:
        ...
        /**
         * Calculate (in place) the hyperboloid tangent corresponding to this
         * vector, when interpreted as a Poincare ball tangent vector at the provided
         * point.
         */
        void to_hyperboloid_tangent(const Vector& ball_point);
